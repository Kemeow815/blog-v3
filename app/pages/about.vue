	...
	<div class="cards-grid">
		...
		<div class="card info-card personality-card">
			...
			<div class="content-center">
				...
				<span class="value-small text-gray">INFJ-T</span>
			</div>
		...
		<div class="card specialty-card">
			...
			<p class="specialty-text">
				平平无奇的 <span class="highlight">“摆烂”者</span>
			</p>
			<p class="specialty-text">
		...
		<div class="card contact-card">
			...
			<div class="contact-links">
				<a href="https://github.com/Kemeow815" target="_blank" rel="noopener noreferrer" title="GitHub:Kemeow815">
